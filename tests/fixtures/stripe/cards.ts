 ...
 * ==============================================
 *
 * BL-024 Fase 1 (2026-05-13) — la SoT REAL de tarjetas Stripe vive acá.
 * Antes esto era un re-export desde `features/gateway-pg/data/stripe-cards.ts`
 * y `stripeTestData.ts`. Ahora la dirección está invertida: los archivos
 * legacy son thin re-exports de este archivo.
 *
 ...
 *     desde `tests/fixtures/stripe/cards`.
 *   - NO duplicar definiciones inline en tests.
 *   - Los re-exports en `features/gateway-pg/data/*` se mantienen por compat
 *     pero nuevos archivos deben importar desde acá directamente.
 *
...
// ═══════════════════════════════════════════════════════════════════════
// LEGACY ALIAS — para compat con código que importa `STRIPE_TEST_CARD_FIXTURES`.
// ═══════════════════════════════════════════════════════════════════════
