 ...
 * El archivo `tests/fixtures/authorize/card-resolver.ts` queda como thin re-export.
 *
 * Convierte un identificador de intención al objeto AuthorizeTestCard completo.
 *
 * Análogo a `tests/fixtures/gateways/stripe/card-resolver.ts`, pero con una diferencia:
