...
test('test', async ({ page }) => {
	...
	await page
		.locator(
			'.ng-tns-c28-2.ng-untouched > div > .search-container > .search-container-input > .bootstrap > .below > .single > .placeholder'
		)
		.first()
		.click();
	...
	await page
		.locator('iframe[name="__privateStripeFrame3263"]')
		.contentFrame()
	...
	await page
		...
		.contentFrame()
		.getByRole('textbox', { name: 'Credit or debit card number' })
		.fill('4000002760003184');
	await page
		.locator('iframe[name="__privateStripeFrame3264"]')
		.contentFrame()
		.getByRole('textbox', { name: 'Credit or debit card' })
		.click();
	await page
		.locator('iframe[name="__privateStripeFrame3264"]')
		.contentFrame()
		...
		.fill('12 / 34');
	await page
		.locator('iframe[name="__privateStripeFrame3265"]')
		.contentFrame()
	...
	await page
		.locator('iframe[name="__privateStripeFrame32611"]')
		.contentFrame()
		.locator('iframe[name="stripe-challenge-frame"]')
		.contentFrame()
		.getByText('3D Secure 2Test Page Complete')
		.click();
	await page
		.locator('iframe[name="__privateStripeFrame32611"]')
		.contentFrame()
	...
	await page
		.locator('iframe[name="__privateStripeFrame32614"]')
		.contentFrame()
		.locator('iframe[name="stripe-challenge-frame"]')
		.contentFrame()
		.getByText('3D Secure 2Test Page Complete')
