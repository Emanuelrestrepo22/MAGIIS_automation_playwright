...
test('test', async ({ page }) => {
  ...
  await page.locator('select-dropdown').getByText('Tarjeta de Crédito - Preautorizada').click();
  await page.locator('iframe[name="__privateStripeFrame3263"]').contentFrame().getByRole('textbox', { name: 'Credit or debit card number' }).click();
  await page.locator('iframe[name="__privateStripeFrame3263"]').contentFrame().getByRole('textbox', { name: 'Credit or debit card number' }).fill('4000002760003184');
  await page.locator('iframe[name="__privateStripeFrame3264"]').contentFrame().getByRole('textbox', { name: 'Credit or debit card' }).click();
  await page.locator('iframe[name="__privateStripeFrame3264"]').contentFrame().getByRole('textbox', { name: 'Credit or debit card' }).fill('12 / 34');
  await page.locator('iframe[name="__privateStripeFrame3265"]').contentFrame().getByRole('textbox', { name: 'Credit or debit card CVC/CVV' }).click();
  await page.locator('iframe[name="__privateStripeFrame3265"]').contentFrame().getByRole('textbox', { name: 'Credit or debit card CVC/CVV' }).fill('123');
  await page.getByRole('textbox').first().click();
  await page.getByRole('textbox').first().fill('emanuel');
  await page.getByRole('textbox').nth(1).click();
  await page.getByRole('textbox').nth(1).fill('1234');
  await page.getByRole('button', { name: 'Validar' }).click();
  await page.locator('iframe[name="__privateStripeFrame32611"]').contentFrame().locator('iframe[name="stripe-challenge-frame"]').contentFrame().getByText('3D Secure 2Test Page Complete').click();
  await page.locator('iframe[name="__privateStripeFrame32611"]').contentFrame().locator('iframe[name="stripe-challenge-frame"]').contentFrame().getByRole('button', { name: 'Complete' }).click();
  await page.getByRole('button', { name: 'Seleccionar Vehículo' }).click();
  await page.getByRole('button', { name: 'Enviar Servicio' }).click();
  await page.locator('iframe[name="__privateStripeFrame32614"]').contentFrame().locator('iframe[name="stripe-challenge-frame"]').contentFrame().getByText('3D Secure 2Test Page Complete').click();
  await page.locator('iframe[name="__privateStripeFrame32614"]').contentFrame().locator('iframe[name="stripe-challenge-frame"]').contentFrame().getByRole('button', { name: 'Complete' }).click();
});