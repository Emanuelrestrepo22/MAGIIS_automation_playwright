...
test('test', async ({ page }) => {
	...
	await page
		.locator('iframe[name="__privateStripeFrame5203"]')
		.contentFrame()
	...
	await page
		.locator('iframe[name="__privateStripeFrame5204"]')
		.contentFrame()
	...
	await page
		...
		.fill('12 / 34');
	await page
		.locator('iframe[name="__privateStripeFrame5205"]')
		.contentFrame()
	...
	await page
		.locator('iframe[name="__privateStripeFrame52011"]')
		.contentFrame()
	...
	await page
		.locator('iframe[name="__privateStripeFrame52014"]')
		.contentFrame()
		.locator('iframe[name="stripe-challenge-frame"]')
		.contentFrame()
		.getByText('3D Secure 2Test Page Complete')
