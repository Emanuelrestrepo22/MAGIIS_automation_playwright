...
test('test', async ({ page }) => {
	...
	await page
		.locator('iframe[name="__privateStripeFrame6073"]')
		.contentFrame()
	...
	await page
		.locator('iframe[name="__privateStripeFrame6074"]')
		.contentFrame()
	...
	await page
		.locator('iframe[name="__privateStripeFrame6075"]')
		.contentFrame()
	...
	await page
		.locator('iframe[name="__privateStripeFrame60711"]')
		.contentFrame()
