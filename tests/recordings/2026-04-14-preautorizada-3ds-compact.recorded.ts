...
test('test', async ({ page }) => {
	...
	await page
		.locator('iframe[name="__privateStripeFrame0613"]')
		.contentFrame()
	...
	await page
		.locator('iframe[name="__privateStripeFrame0614"]')
		.contentFrame()
	...
	await page
		...
		.fill('12 / 34');
	await page
		.locator('iframe[name="__privateStripeFrame0615"]')
		.contentFrame()
	...
	await page
		.locator('iframe[name="__privateStripeFrame06111"]')
		.contentFrame()
	...
	await page
		.locator('iframe[name="__privateStripeFrame06114"]')
		.contentFrame()
		.locator('iframe[name="stripe-challenge-frame"]')
		.contentFrame()
		.getByText('3D Secure 2Test Page Complete')
