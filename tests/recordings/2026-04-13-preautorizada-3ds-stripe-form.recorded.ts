...
test('test', async ({ page }) => {
	...
	await page
		.locator('iframe[name="__privateStripeFrame1523"]')
		.contentFrame()
	...
	await page
		.locator('iframe[name="__privateStripeFrame1524"]')
		.contentFrame()
	...
	await page
		...
		.fill('12 / 34');
	await page
		.locator('iframe[name="__privateStripeFrame1525"]')
		.contentFrame()
	...
	await page
		.locator('iframe[name="__privateStripeFrame15211"]')
		.contentFrame()
	...
	await page
		.locator('iframe[name="__privateStripeFrame15214"]')
		.contentFrame()
		.locator('iframe[name="stripe-challenge-frame"]')
		.contentFrame()
		.getByRole('button', { name: 'Complete' })
