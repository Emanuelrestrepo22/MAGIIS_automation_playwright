...
/**
 * Stripe 3DS Challenge Modal — POM Stripe-specific.
 *
 ...
 *
 * Movido desde `pages/carrier/ThreeDSModal.ts` en 2026-05-13 (organización
 * multi-gateway). El archivo viejo queda como thin re-export.
 */
