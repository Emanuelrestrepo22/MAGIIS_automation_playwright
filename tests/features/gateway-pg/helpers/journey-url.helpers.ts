/**
 * Journey URL helpers — gateway-agnostic.
 * =========================================
 *
 * Helpers para inspeccionar el URL del browser tras un submit de viaje.
 * NO dependen de ningún gateway específico (Stripe / Authorize / etc.) —
 * la URL post-submit es una respuesta de MAGIIS frontend, no del SDK.
 *
 ...
 *
 * Para tarjetas sin 3DS el hold ocurre internamente en el gateway — sin popup
 * ni request visible desde el test. La validación del hold se hace:
 *   - Dashboard del gateway (externo), o
