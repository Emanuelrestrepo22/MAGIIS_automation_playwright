 ...
 *   (MG-158..160); 3DS -> área D (MG-152..157). mapeo por área aceptado (idmap API-level,
...
test.describe.serial('Gateway PG · E2E Mobile · App Pax Business — Hold con 3DS @gateway @stripe @e2e-hybrid @hold @3ds @regression', () => {
