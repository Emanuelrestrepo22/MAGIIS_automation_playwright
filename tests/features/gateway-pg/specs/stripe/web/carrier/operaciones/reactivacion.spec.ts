 ...
 * mapear al área REACT del idmap (MG-440+, Level UI) — PENDIENTE REASIGNAR.
 */
...
test.describe('Gateway PG · Carrier · Empresa Individuo — Reactivación de Viajes @gateway @stripe @hold @3ds @regression', () => {
