...
test.describe('Gateway PG · Carrier · Empresa Individuo — Clonación de Viajes Cancelados @gateway @stripe @hold @3ds @regression', { annotation: [{ type: 'tms', description: 'MG-428' }] }, () => {
