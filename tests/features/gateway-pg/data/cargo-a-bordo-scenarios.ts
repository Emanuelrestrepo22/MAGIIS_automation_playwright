...
export const CARGO_SCENARIOS = {
	...
	appPax_insufficientFunds: {
		tcId: 'TC1083',
		cardKey: 'declined_funds',
	...
	appPax_antifraud_cvc: {
		tcId: 'TC1087',
		cardKey: 'cvc_check_fail',
		expectedResult: 'antifraud',
		userType: 'app-pax'
	},
	appPax_antifraud_risk: {
		tcId: 'TC1088',
		cardKey: 'highest_risk',
		expectedResult: 'antifraud',
		userType: 'app-pax'
	},
	appPax_antifraud_blocked: {
		tcId: 'TC1089',
		cardKey: 'always_blocked',
		expectedResult: 'antifraud',
		userType: 'app-pax'
	},
	appPax_antifraud_zip: {
		tcId: 'TC1090',
		cardKey: 'zip_fail_elevated',
		expectedResult: 'antifraud',
		userType: 'app-pax'
	},
	appPax_antifraud_addr: {
		tcId: 'TC1091',
		cardKey: 'address_unavailable',
		expectedResult: 'antifraud',
		userType: 'app-pax'
	},
	appPax_3ds_success: {
		tcId: 'TC1092',
		cardKey: 'visa_3ds_success',
		expectedResult: 'approved-after-3ds',
		userType: 'app-pax'
	},
	...
	empresa_happy: {
		tcId: 'TC1111',
		cardKey: 'visa_success',
		expectedResult: 'approved',
		userType: 'empresa-individuo'
	}
